    ...
    public class ClashRunner
    {
        ...
        public static void RunClash(string configFilePath)
        {
            try
            {
                ...
                // 指定临时文件路径
                string clashExecutablePath = Path.Combine(currentDir, "mihomo.exe");
                ...
                ProcessStartInfo startInfo = new ProcessStartInfo
                {
                    ...
                    Arguments = $"-f \"{configFilePath}\"",  // 指定配置文件（加引号处理空格）
        ...
        private static void ExtractClashExecutable(string outputPath)
        {
            try
            {
                ...
                // 获取嵌入资源的名称
                string resourceName = "Befree.Resources.mihomo-windows-amd64-compatible.exe"; // 这里的名称要与资源名称一致
